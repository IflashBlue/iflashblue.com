...
class Project implements TranslationInterface, EntityInterface
{
    ...
    #[ORM\JoinTable(name: 'project_translations')]
    ...
    #[ORM\ManyToOne(targetEntity: Category::class, cascade: ['all'], fetch: 'EAGER', inversedBy: 'projects')]
